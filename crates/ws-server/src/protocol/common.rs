...
use super::{
    ...
    terminal::{
        TerminalCreate, TerminalCreated, TerminalHistory, TerminalInput, TerminalKill,
        TerminalMount, TerminalMounted, TerminalOutput, TerminalRemoved, TerminalRename,
        TerminalReorder, TerminalRequestHistory, TerminalResize, TerminalSessionData,
        TerminalSessionEnded, TerminalTabClose, TerminalTabClosed, TerminalTabHistory,
        TerminalTabList, TerminalUnmount, TerminalUpdated,
    },
    uuid_serde,
    workspace::{
    ...
    worktree::{
        ...
        WorktreeListResult, WorktreeMerge, WorktreeStatus, WorktreeUpdate, WorktreeUpdated,
    },
};
...
pub enum ClientMessagePayload {
    ...
    TerminalRequestHistory(TerminalRequestHistory),
    TerminalMount(TerminalMount),
    TerminalUnmount(TerminalUnmount),
    TerminalTabClose(TerminalTabClose),
...
pub enum ServerMessagePayload {
    ...
    TerminalSessionEnded(TerminalSessionEnded),
    TerminalTabHistory(TerminalTabHistory),
    TerminalTabList(TerminalTabList),
    TerminalTabClosed(TerminalTabClosed),
